...
```js
var vibranced = require('vibranced');
...
```js
var vibranced = require('vibranced/safe');

console.log(vibranced.green('hello')); // outputs green text
console.log(vibranced.red.underline('i like cake and pies')); // outputs red underlined text
console.log(vibranced.inverse('inverse the color')); // inverses the color
console.log(vibranced.rainbow('OMG Rainbows!')); // rainbow
console.log(vibranced.trap('Run the trap')); // Drops the bass
...
```js
var name = 'Marak';
console.log(vibranced.green('Hello %s'), name);
// outputs -> 'Hello Marak'
```
...
// outputs red text
console.log(vibranced.error("this is an error"));

// outputs yellow text
console.log(vibranced.warn("this is a warning"));
